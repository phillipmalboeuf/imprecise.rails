...
# docker build -t imprecise_analysis .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name imprecise_analysis imprecise_analysis
...
# Install npm dependencies for asset compilation (Tailwind CSS, DaisyUI, etc.)
